...
motor FrontRight = motor(PORT2, ratio6_1, true);
motor BackLeft = motor(PORT3, ratio6_1, false);
motor BackRight = motor(PORT4, ratio6_1, true);
motor TopLeft = motor(PORT11, ratio6_1, true);
motor TopRight = motor(PORT12, ratio6_1, false);
